...
module.exports = {
  ...
  /**
   * Promise to search a/an producttype.
   *
   * @return {Promise}
   */
  ...
  search: async (params) => {
    ...
    const $or = Object.keys(Producttype.attributes).reduce((acc, curr) => {
      switch (Producttype.attributes[curr].type) {
        case 'integer':
        case 'float':
        case 'decimal':
